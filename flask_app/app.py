...
def load_model_and_vectorizer(model_name, model_version, vectorizer_path):
    ...
    dagshub.init(repo_owner='rk2289868', repo_name='YouTube-Comment-Analysis', mlflow=True)  # Replace with your MLflow tracking URI
    client = MlflowClient()
...
def predict_with_timestamps():
    ...
    try:
        ...
        print(f"Error in /predict_with_timestamps: {str(e)}")
        return jsonify({"error": f"Prediction failed: {str(e)}"}), 500
